...
--
-- Host: mysql.test.superkablamo.com
-- Generation Time: May 29, 2009 at 07:55 AM
...
CREATE TABLE IF NOT EXISTS `content_type_page` (
  `vid` int(10) unsigned NOT NULL default '0',
  `nid` int(10) unsigned NOT NULL default '0',
  `field_test_rating` int(10) unsigned default NULL,
  `field_test_target` int(10) unsigned default NULL,
  PRIMARY KEY  (`vid`),
  KEY `nid` (`nid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
